...
public interface FeatureResolver {
    ...
    public interface Repository {
         ...
         * be the short name (if it is a public feature) the full symbolic
         * name, or the symbolic or short alias. The full symbolic name will
         * include the version (e.g. com.ibm.ws.something_1.0)
         *
